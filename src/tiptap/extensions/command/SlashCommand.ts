...
import { renderGroups } from "./MenuItem";
import CommandsList from "./Component";
...
export const SlashCommand = Extension.create({
  ...
  priority: 200,
  /**
   * Creates a Tippy.js popup for the slash command suggestions.
   * This popup is shared across all editor instances.
   * @returns {void}
   */
  onCreate() {
    popup = tippy("body", {
